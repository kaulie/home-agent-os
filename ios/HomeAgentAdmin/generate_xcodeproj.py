#!/usr/bin/env python3
"""Generate a minimal Xcode project for HomeAgent Admin (现场管理中控)."""
...
SRC = ROOT / "HomeAgentAdmin"
PROJ = ROOT / "HomeAgentAdmin.xcodeproj"
APP_NAME = "HomeAgentAdmin"
BUNDLE_ID = "com.gaolei.homeagent.admin"
