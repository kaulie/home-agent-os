#!/usr/bin/env python3
"""Generate a minimal Xcode project for HomeAgent Admin (Dev Console 开发运维)."""
...
SRC = ROOT / "HomeAgentDev"
PROJ = ROOT / "HomeAgentDev.xcodeproj"
APP_NAME = "HomeAgentDev"
BUNDLE_ID = "com.gaolei.homeagent.dev"
...
def main() -> None:
    ...
    print(f"Wrote {PROJ / 'project.pbxproj'} with {len(files)} swift files{extra}")
