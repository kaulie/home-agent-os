package com.smarthome.livingroom_android.brain.dto
...
object ParticipantWire {
    ...
    /** Console default: emit + execute local caps + display. */
    fun defaultRoles(): List<String> = listOf(ROLE_INTENT_SOURCE, ROLE_RUNTIME, ROLE_ENDPOINT)
