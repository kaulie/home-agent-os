...
import com.smarthome.livingroom_v2.app.LivingRoomV2App
import com.smarthome.livingroom_v2.app.MainActivity
...
class EdgeAgentService : Service() {
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        startAsForeground()
        runCatching {
            LivingRoomV2App.instance.edgeAgent.start()
    ...
    override fun onDestroy() {
        runCatching {
            if (LivingRoomV2App.instance.edgeAgent.running) {
                LivingRoomV2App.instance.edgeAgent.stop()
